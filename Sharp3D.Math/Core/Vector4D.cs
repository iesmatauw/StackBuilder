...
namespace Sharp3D.Math.Core
{
	...
	public struct Vector4D : ICloneable
	{
		...
		/// </summary>
		/// <param name="value">A string representation of a <see cref="Vector4D"/>.</param>
		/// <returns>A <see cref="Vector4D"/> that represents the vector specified by the <paramref name="value"/> parameter.</returns>
		...
		/// contains a <see cref="Vector4D"/> representing the vector specified by <paramref name="value"/>.
		/// </param>
