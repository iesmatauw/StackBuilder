...
namespace Sharp3D.Math.Core
{
	...
	public struct Vector2F : ICloneable
	{
		...
		/// </summary>
		/// <param name="value">A string representation of a <see cref="Vector2F"/>.</param>
		/// <returns>A <see cref="Vector2F"/> that represents the vector specified by the <paramref name="value"/> parameter.</returns>
		...
		/// contains a <see cref="Vector2F"/> representing the vector specified by <paramref name="value"/>.
		/// </param>
